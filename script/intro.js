...
function intro() {
  ...
  switch (cenaIntro) {
    ...
    case 1:
      ...
      animar(
        ...
        idioma(
          ...
          Pela primeira vez ocorre sua exibição na América Latina, com todos os seus materiais traduzidos numa versão bilíngue, para o português e espanhol, mediante uma parceria entre o Fórum Permanente, o Instituto de Estudos Avançados da USP e a Biblioteca Brasiliana José e Guita Mindlin, com o apoio do Governo do Estado de São Paulo através do PROAC.`,
      ...
      animar("introNum", "intro-texto", "01/03", ["intro-num"]);
      break;
    ...
    case 2:
      ...
      animar("introNum", "intro-texto", "02/03", ["intro-num"]);
      break;
    ...
    case 3:
      ...
      animar("introNum", "intro-texto", "03/03", ["intro-num"]);
      break;
    case 4:
